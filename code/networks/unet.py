...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.out_conv_binary = nn.Conv2d(self.ft_chns[0], 2,
                                  kernel_size=3, padding=1)
    ...
    def forward(self, feature):
        ...
        output_binary = self.out_conv_binary(x)
        return output, f, output_binary
...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        output, f, output_binary = self.decoder(feature)
        return output, f, output_binary
